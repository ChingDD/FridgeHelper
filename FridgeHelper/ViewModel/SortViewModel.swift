...
class SortViewModel {
    var sortOptionObservor: ObservableObject = ObservableObject<SortMethod>(value: .取消)
    
    func setSortOptions(option: SortMethod) {
        sortOptionObservor.value = option
    }
}
